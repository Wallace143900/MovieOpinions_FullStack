...
let UserServices = class UserServices {
    register(body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const schemaReturn = user_schemas_1.userReturnSchema.parse(data);
            return schemaReturn;
        });
    }
    login(body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!compare) {
                throw new appError_1.AppError("Senha incorreta", 404);
            }
            const secret = process.env.JWT_SECRET;
            if (!secret) {
                throw new appError_1.AppError("JWT_SECRET não configurado no ambiente", 401);
            }
